...
import { getHistoryList } from "@/lib/api/others/history/routes";
...
export default function PageContent() {
  ...
  const queryKeyData = "history-data";
  ...
  const mutationDownload = useMutation({
    mutationFn: async (item: DownloadRequest) => downloadData("history", item),
