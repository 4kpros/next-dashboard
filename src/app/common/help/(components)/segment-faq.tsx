...
const items: CollapseProps["items"] = [
  ...
  },
  {
    ...
    children: (
      <p>
        ...
        child&lsquo;s scores and feedback as soon as results are posted. Receive
  ...
  {
    key: "4",
    label: "How can I track my child&lsquo;s exam results?",
    children: (
      <p>
        Sign up by providing your details and linking your child&lsquo;s profile.
        Complete the registration process through the email verification link.
        After registration, you will have access to your child&lsquo;s academic
        updates.
      </p>
    ),
  },
  ...
  {
    key: "7",
    label: "How do I communicate with my child&lsquo;s teachers?",
    children: (
      <p>
