import { CommunicationListRequest, CommunicationRequest } from "@/lib/api/others/communication/request";
import { CommunicationListResponse, CommunicationResponse } from "@/lib/api/others/communication/response";
